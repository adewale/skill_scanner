...
- **Image metadata** -- PNG `tEXt`/`zTXt`/`iTXt` chunks, JPEG comment/EXIF fields, GIF comment/application extensions, WebP EXIF/XMP chunks, and PNG-encoded ICO frames are decoded (pure stdlib) and scanned for hidden instructions.
